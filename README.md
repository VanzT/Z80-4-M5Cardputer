...
- Exiting any game requires you to reset the Cardputer to get back to the CP/M prompt.  This does not apply to BASIC games, but exiting BASIC also requires a reset of the Cardputer.
