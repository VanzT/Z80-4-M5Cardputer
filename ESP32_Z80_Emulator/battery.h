...
void displayBatteryLevel() {
    ...
    M5.Display.fillRect(10, 100, 160, 20, BLACK);  // Clear the area (adjust width/height as needed)

    M5.Display.setCursor(10, 100);                 // Move the cursor to the desired position
